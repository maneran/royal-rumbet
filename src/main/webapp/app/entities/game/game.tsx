            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('gameType')}>
                    Game Type <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('stageType')}>
                    Stage Type <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    Opponent A <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    Opponent B <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
              ...
              <tbody>
                {gameList.map((game, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>{game.name}</td>
                    <td>{game.dateStart ? <TextFormat type="date" value={game.dateStart} format={APP_DATE_FORMAT} /> : null}</td>
                    <td>{game.gameType}</td>
                    <td>{game.stageType}</td>
                    <td>{game.opponentA ? <Link to={`opponent/${game.opponentA.id}`}>{game.opponentA.name}</Link> : ''}</td>
                    <td>{game.opponentB ? <Link to={`opponent/${game.opponentB.id}`}>{game.opponentB.name}</Link> : ''}</td>
                    <td>{game.tournament ? <Link to={`tournament/${game.tournament.id}`}>{game.tournament.name}</Link> : ''}</td>
