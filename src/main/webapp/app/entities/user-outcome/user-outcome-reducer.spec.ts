...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USEROUTCOME_LIST actions', async () => {
    ...
    it('dispatches FETCH_USEROUTCOME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USEROUTCOME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USEROUTCOME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USEROUTCOME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USEROUTCOME actions', async () => {
      const expectedActions = [
        {
