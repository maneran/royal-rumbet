...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GAMECONFIG_LIST actions', async () => {
    ...
    it('dispatches FETCH_GAMECONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GAMECONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GAMECONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GAMECONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GAMECONFIG actions', async () => {
      const expectedActions = [
        {
