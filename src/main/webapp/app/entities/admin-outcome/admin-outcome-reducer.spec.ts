...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADMINOUTCOME_LIST actions', async () => {
    ...
    it('dispatches FETCH_ADMINOUTCOME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADMINOUTCOME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADMINOUTCOME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADMINOUTCOME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADMINOUTCOME actions', async () => {
      const expectedActions = [
        {
