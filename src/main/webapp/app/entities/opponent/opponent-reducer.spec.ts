...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './opponent.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPPONENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_OPPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OPPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OPPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OPPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OPPONENT actions', async () => {
      const expectedActions = [
        {
