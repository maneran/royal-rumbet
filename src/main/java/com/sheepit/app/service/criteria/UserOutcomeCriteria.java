...
/**
 * Criteria class for the {@link com.sheepit.app.domain.UserOutcome} entity. This class is used
 * in {@link com.sheepit.app.web.rest.UserOutcomeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /user-outcomes?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class UserOutcomeCriteria implements Serializable, Criteria {
    ...
    public UserOutcomeCriteria() {}

    public UserOutcomeCriteria(UserOutcomeCriteria other) {
    ...
    @Override
    public UserOutcomeCriteria copy() {
        return new UserOutcomeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final UserOutcomeCriteria that = (UserOutcomeCriteria) o;
        return (
